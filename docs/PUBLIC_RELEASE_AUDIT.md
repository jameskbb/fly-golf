...
- Added after the audit: `apps/web/public/anatomy/malecns-brain-somata.json` (about 21 kB), a binned
  map of MaleCNS v1.0 brain cell-body positions for the web app's brain view, generated by
  `services/sim/scripts/build_soma_map.py`. It holds no connectivity and carries the CC BY 4.0
